...
REM
REM Generated by Vivado on Fri Jun 19 15:02:59 +0530 2026
...
echo "xvlog --incr --relax -prj cba_4bit_tb_vlog.prj"
call xvlog  --incr --relax -prj cba_4bit_tb_vlog.prj -log xvlog.log
