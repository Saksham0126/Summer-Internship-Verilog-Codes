...
REM
REM Generated by Vivado on Fri Jun 19 23:00:04 +0530 2026
...
echo "xvlog --incr --relax -prj tb_simple_multiplier_vlog.prj"
call xvlog  --incr --relax -prj tb_simple_multiplier_vlog.prj -log xvlog.log
