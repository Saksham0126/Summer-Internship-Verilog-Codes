...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {ans[0]}] ;# LD0
set_property PACKAGE_PIN T21 [get_ports {ans[1]}] ;# LD1
set_property PACKAGE_PIN U22 [get_ports {ans[2]}] ;# LD2
set_property PACKAGE_PIN U21 [get_ports {ans[3]}] ;# LD3
set_property PACKAGE_PIN V22 [get_ports {R[0]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {R[1]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {R[2]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {R[3]}];  # "LD7"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {Q[0]}]  ;# SW0
set_property PACKAGE_PIN G22 [get_ports {Q[1]}]  ;# SW1
set_property PACKAGE_PIN H22 [get_ports {Q[2]}]  ;# SW2
set_property PACKAGE_PIN F21 [get_ports {Q[3]}]  ;# SW3
set_property PACKAGE_PIN H19 [get_ports {M[0]}]  ;# SW4
set_property PACKAGE_PIN H18 [get_ports {M[1]}]  ;# SW5
set_property PACKAGE_PIN H17 [get_ports {M[2]}]  ;# SW6
set_property PACKAGE_PIN M15 [get_ports {M[3]}]  ;# SW7
