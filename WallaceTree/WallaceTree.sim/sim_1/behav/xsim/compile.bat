...
REM
REM Generated by Vivado on Mon Jun 08 16:57:51 +0530 2026
...
echo "xvlog --incr --relax -prj wtm_tb_vlog.prj"
call xvlog  --incr --relax -prj wtm_tb_vlog.prj -log xvlog.log
