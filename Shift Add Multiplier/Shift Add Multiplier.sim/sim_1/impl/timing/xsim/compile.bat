...
REM
REM Generated by Vivado on Thu Jun 18 23:27:30 +0530 2026
...
echo "xvlog --incr --relax -prj tb_SHAM_vlog.prj"
call xvlog  --incr --relax -prj tb_SHAM_vlog.prj -log xvlog.log
