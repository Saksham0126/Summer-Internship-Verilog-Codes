...
REM
REM Generated by Vivado on Mon Jun 15 14:13:22 +0530 2026
...
echo "xvlog --incr --relax -prj LCSA_tb_vlog.prj"
call xvlog  --incr --relax -prj LCSA_tb_vlog.prj -log xvlog.log
