...
REM
REM Generated by Vivado on Wed Jun 17 02:21:54 +0530 2026
...
echo "xvlog --incr --relax -prj tb_FPU_simple_vlog.prj"
call xvlog  --incr --relax -prj tb_FPU_simple_vlog.prj -log xvlog.log
