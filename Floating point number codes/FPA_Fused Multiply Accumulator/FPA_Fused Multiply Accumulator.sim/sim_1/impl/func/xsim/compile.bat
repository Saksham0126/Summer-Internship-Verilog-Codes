...
REM
REM Generated by Vivado on Sat Jun 20 13:28:19 +0530 2026
...
echo "xvlog --incr --relax -prj tb_FMA_Simple_vlog.prj"
call xvlog  --incr --relax -prj tb_FMA_Simple_vlog.prj -log xvlog.log
