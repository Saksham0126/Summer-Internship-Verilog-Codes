...
REM
REM Generated by Vivado on Sun Jun 28 17:22:50 +0530 2026
...
echo "xvlog --incr --relax -prj tb_prac_vlog.prj"
call xvlog  --incr --relax -prj tb_prac_vlog.prj -log xvlog.log
