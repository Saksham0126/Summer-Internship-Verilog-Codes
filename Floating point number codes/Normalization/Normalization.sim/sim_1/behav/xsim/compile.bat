...
REM
REM Generated by Vivado on Tue Jun 16 23:51:54 +0530 2026
...
echo "xvlog --incr --relax -prj tb_norm_standalone_vlog.prj"
call xvlog  --incr --relax -prj tb_norm_standalone_vlog.prj -log xvlog.log
