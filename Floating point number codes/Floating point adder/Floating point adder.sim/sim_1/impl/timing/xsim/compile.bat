...
REM
REM Generated by Vivado on Tue Jun 16 14:06:54 +0530 2026
...
echo "xvlog --incr --relax -prj tb_FPA_5Cases_vlog.prj"
call xvlog  --incr --relax -prj tb_FPA_5Cases_vlog.prj -log xvlog.log
