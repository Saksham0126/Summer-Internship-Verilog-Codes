...
REM
REM Generated by Vivado on Wed Jun 17 00:01:45 +0530 2026
...
echo "xvlog --incr --relax -prj tb_FPM_vlog.prj"
call xvlog  --incr --relax -prj tb_FPM_vlog.prj -log xvlog.log
