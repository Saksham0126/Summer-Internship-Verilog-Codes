...
REM
REM Generated by Vivado on Tue Jun 16 23:41:07 +0530 2026
...
echo "xvlog --incr --relax -prj tb_div_fp_vlog.prj"
call xvlog  --incr --relax -prj tb_div_fp_vlog.prj -log xvlog.log
