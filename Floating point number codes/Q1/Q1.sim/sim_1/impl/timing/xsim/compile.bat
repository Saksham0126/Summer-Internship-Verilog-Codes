...
REM
REM Generated by Vivado on Mon Jun 29 23:34:16 +0530 2026
...
echo "xvlog --incr --relax -prj tb_sequence_detector_1011_gate_main_vlog.prj"
call xvlog  --incr --relax -prj tb_sequence_detector_1011_gate_main_vlog.prj -log xvlog.log
