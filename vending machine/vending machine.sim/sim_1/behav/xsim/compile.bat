...
REM
REM Generated by Vivado on Thu Jun 18 18:02:53 +0530 2026
...
echo "xvlog --incr --relax -prj vendiTB_vlog.prj"
call xvlog  --incr --relax -prj vendiTB_vlog.prj -log xvlog.log
