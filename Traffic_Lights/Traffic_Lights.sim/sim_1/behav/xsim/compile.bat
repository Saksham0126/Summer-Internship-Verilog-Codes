...
REM
REM Generated by Vivado on Thu Jun 04 15:10:12 +0530 2026
...
echo "xvlog --incr --relax -prj TL_tb_vlog.prj"
call xvlog  --incr --relax -prj TL_tb_vlog.prj -log xvlog.log
