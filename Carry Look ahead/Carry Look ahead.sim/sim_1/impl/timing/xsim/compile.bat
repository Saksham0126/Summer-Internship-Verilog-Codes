...
REM
REM Generated by Vivado on Fri Jun 19 12:29:49 +0530 2026
...
echo "xvlog --incr --relax -prj clatb_vlog.prj"
call xvlog  --incr --relax -prj clatb_vlog.prj -log xvlog.log
