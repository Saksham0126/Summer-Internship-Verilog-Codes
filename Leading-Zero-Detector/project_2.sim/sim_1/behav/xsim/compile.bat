...
REM
REM Generated by Vivado on Sun Jun 07 13:07:10 +0530 2026
...
echo "xvlog --incr --relax -prj LZD_tb_vlog.prj"
call xvlog  --incr --relax -prj LZD_tb_vlog.prj -log xvlog.log
