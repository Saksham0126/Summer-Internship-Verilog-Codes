...
REM
REM Generated by Vivado on Sat Jun 20 01:32:01 +0530 2026
...
echo "xvlog --incr --relax -prj tb_boothm_vlog.prj"
call xvlog  --incr --relax -prj tb_boothm_vlog.prj -log xvlog.log
